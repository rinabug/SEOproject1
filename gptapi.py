...
# Specify the model to use and the messages to send
    completion = client.chat.completions.create(
        ...
        messages=[
            ...
            {"role": "user", "content": f'The Weather is : {info} What outfit should I wear? Also, output the temperature in fahrenheit and celcius and output the outfit recomendation as a numbered list.'}
        ]
    )   
